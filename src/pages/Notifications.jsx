...
export default function Notifications() {
  ...
  async function openNotification(item) {
    try {
      ...
      console.error("Could not mark notification as read:", markError);
    }
  ...
  async function handleMarkAllRead() {
    try {
      ...
      console.error("Could not mark notifications as read:", markError);
        ...
        {loading ? (
          ...
          <div className="notifications-empty notification-empty-card">
            ...
            <p>
              ...
              Chain replies, and forum activity
              will appear here.
            </p>
          </div>
        ) : (
          <div className="notification-list">
            {items.map((item) => {
              const actorAvatar = getProfileAvatar(item.actorAvatar);
