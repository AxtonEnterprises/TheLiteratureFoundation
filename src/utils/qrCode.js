 ...
 * MIT License. Bundled locally so invitation URLs never leave Lit Chain
 * just to render a QR code.
 */
const __modules = {
...
function __require(id) {
  ...
  if (__cache[clean]) return __cache[clean].exports;
  const factory = __modules[clean];
  if (!factory) throw new Error(`Unknown QR module: ${id}`);
  const module = { exports: {} };
  __cache[clean] = module;
